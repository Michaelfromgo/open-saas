...
import { updateCurrentUserLastActiveTimestamp as updateCurrentUserLastActiveTimestamp_ext } from 'wasp/src/user/operations'
...
// PRIVATE API
export type UpdateCurrentUserLastActiveTimestamp_ext = typeof updateCurrentUserLastActiveTimestamp_ext

// PUBLIC API
export const updateCurrentUserLastActiveTimestamp: AuthenticatedOperationFor<UpdateCurrentUserLastActiveTimestamp_ext> =
  createAuthenticatedOperation(
    updateCurrentUserLastActiveTimestamp_ext,
    {
      User: prisma.user,
    },
  )
