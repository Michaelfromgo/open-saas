...
import updateCurrentUserLastActiveTimestamp from './updateCurrentUserLastActiveTimestamp.js'
...
router.post('/update-current-user-last-active-timestamp', auth, updateCurrentUserLastActiveTimestamp)
