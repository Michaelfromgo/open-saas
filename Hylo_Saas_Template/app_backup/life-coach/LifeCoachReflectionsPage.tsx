...
const LifeCoachReflectionsPage = () => {
  return (
      ...
      <div className="flex justify-between items-center mb-8">
        <div>
          ...
          <p className="text-gray-600 dark:text-gray-300 mt-1">
            Review your progress and insights over time
          </p>
        </div>
      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6">
        <div className="text-center py-10">
          <p className="text-gray-600 dark:text-gray-400">
            Reflections will be generated automatically after you've made several check-ins.
          </p>
          <p className="text-gray-600 dark:text-gray-400 mt-2">
            Check back after you've used the daily check-in feature for at least a week.
          </p>
          <div className="mt-6">
            <Link
...
export default LifeCoachReflectionsPage; 